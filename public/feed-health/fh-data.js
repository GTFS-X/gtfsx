...
// Run date: 2026-07-31.  Re-run scripts/feed-health-publish.py to refresh.
(function () {
  ...
  //        feeds counted in each state, so sum > 77 total distinct feeds)
  ...
  const STATES = [
    ...
    S("12","FL","Florida","South",72,75,43,17,0),
    S("13","GA","Georgia","South",83,18,25,8,0),
    S("15","HI","Hawaii","West",4,100,0,33,0),
    S("16","ID","Idaho","West",14,79,17,17,0),
    S("17","IL","Illinois","Midwest",98,29,35,12,0),
    ...
    S("29","MO","Missouri","Midwest",34,41,57,0,0),
    S("30","MT","Montana","West",46,35,43,29,0),
    ...
    S("41","OR","Oregon","West",42,98,11,6,4),
    S("42","PA","Pennsylvania","Northeast",50,70,0,0,0),
    S("44","RI","Rhode Island","Northeast",2,100,0,0,0),
    S("45","SC","South Carolina","South",26,58,38,25,0),
    S("46","SD","South Dakota","Midwest",22,18,0,0,0),
    S("47","TN","Tennessee","South",26,69,29,14,1),
    S("48","TX","Texas","South",71,76,33,27,1),
